...
[https://pros2s-middle-project.netlify.app]

Логин: admin

Пароль: 123

В качестве базы данных был использован json-server, поэтому регистрация будет работать только на локальном сервере.
