...
describe('getArticleData', () => {
  ...
  test('should return article details error message', () => {
    const state: DeepPartial<StateSchema> = {
      articleDetails: { errorMessage: 'true' },
    };

    expect(getArticleErrorMessage(state as StateSchema)).toEqual('true');
  });
});
