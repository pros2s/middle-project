...
exports.ThemeSwitcher = react_1.memo(function (_a) {
    ...
    var _b = ThemesProvider_1.useThemes(), theme = _b.theme, toggleTheme = _b.toggleTheme;
    var Component = react_1.useMemo(function () {
        var Comp;
        switch (theme) {
    ...
    return (React.createElement(Button_1.Button, { className: classNames_1.classNames('', [className]), theme: Button_1.ButtonThemes.CLEAR, onClick: toggleTheme }, Component));
});
